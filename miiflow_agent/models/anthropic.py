...
ANTHROPIC_MODELS: Dict[str, ModelConfig] = {
    "claude-opus-4.6": ModelConfig(
        ...
        description="Anthropic's most capable model with superior intelligence across coding, reasoning, and complex agentic tasks. Features extended thinking and structured outputs.",
        support_images=True,
        support_files=True,
    ...
    "claude-sonnet-4.6": ModelConfig(
        ...
        description="High-performance model with excellent balance of intelligence, speed, and cost. Features extended thinking and structured outputs.",
        support_images=True,
        support_files=True,
        support_streaming=True,
        supports_json_mode=True,
