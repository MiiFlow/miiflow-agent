...
OPENAI_MODELS: Dict[str, ModelConfig] = {
    ...
    "gpt-5.4-mini": ModelConfig(
        ...
        name="gpt-5.4-mini",
        description="GPT-5.4 Mini is a smaller, faster GPT-5.4 variant with strong reasoning at lower cost. Released March 17, 2026.",
        support_images=True,
        support_files=True,
        support_streaming=True,
        supports_json_mode=True,
    ...
    "gpt-5.4-nano": ModelConfig(
        ...
        name="gpt-5.4-nano",
        description="GPT-5.4 Nano is the most cost-effective GPT-5.4 variant, API-only. Released March 17, 2026.",
        support_images=True,
        support_files=True,
        support_streaming=True,
        supports_json_mode=True,
    ...
    # GPT-5.2 series (released December 2025) — legacy, succeeded by GPT-5.4
    "gpt-5.2": ModelConfig(
        model_identifier="gpt-5.2",
        name="gpt-5.2",
        description="Legacy — succeeded by GPT-5.4 (March 2026). 400K context window, optimized for coding and agentic tasks.",
        support_images=True,
        support_files=True,
        support_streaming=True,
        supports_json_mode=True,
    ...
    "gpt-5.2-pro": ModelConfig(
        ...
        name="gpt-5.2-pro",
        description="Legacy — succeeded by GPT-5.4 Pro. Previously OpenAI's highest-accuracy model, exceeding 90% on ARC-AGI-1 benchmark.",
        support_images=True,
        support_files=True,
        support_streaming=True,
        supports_json_mode=True,
    ...
    "gpt-5.1": ModelConfig(
        ...
        name="gpt-5.1",
        description="Legacy — succeeded by GPT-5.4. 400K context window with improved instruction-following.",
        support_images=True,
        support_files=True,
        support_streaming=True,
        supports_json_mode=True,
    ...
    "gpt-5": ModelConfig(
        ...
        name="gpt-5",
        description="Legacy — succeeded by GPT-5.4. Original GPT-5 model.",
        support_images=True,
        support_files=True,
        support_streaming=True,
        supports_json_mode=True,
    ...
    "gpt-5-mini": ModelConfig(
        ...
        name="gpt-5-mini",
        description="Legacy — succeeded by GPT-5.4 Mini. Smaller, cost-efficient GPT-5 with adaptive reasoning.",
        support_images=True,
        support_files=True,
        support_streaming=True,
        supports_json_mode=True,
    ...
    "gpt-5-nano": ModelConfig(
        ...
        name="gpt-5-nano",
        description="Legacy — succeeded by GPT-5.4 Nano. Most cost-effective GPT-5 variant.",
        support_images=True,
        support_files=True,
        support_streaming=True,
        supports_json_mode=True,
    ...
    "gpt-5-pro": ModelConfig(
        ...
        name="gpt-5-pro",
        description="Legacy — succeeded by GPT-5.4 Pro. High-accuracy GPT-5 variant for mission-critical tasks.",
        support_images=True,
        support_files=True,
        support_streaming=True,
        supports_json_mode=True,
        ...
        token_param_name="max_completion_tokens",
        supports_temperature=False,
        input_cost_hint=15.00,
        output_cost_hint=120.00,
    ),
}
